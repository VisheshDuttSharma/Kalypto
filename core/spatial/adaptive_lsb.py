...
# 🔥 Deterministic adaptive pattern
def get_bits(x, y):
...
def encode(image_path, message, output_path):
    ...
    # Approx capacity (safe upper bound)
    ...
    for y in range(height):
        for x in range(width):
            ...
            # Clear last 'bits' bits and insert new value
            r = (r & ~((1 << bits) - 1)) | value
